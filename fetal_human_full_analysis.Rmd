...
twenty_three_AA_supply <- sweep(twenty_three_AA_supply, 2, colSums(twenty_three_AA_supply), "/")
twenty_three_AA_demand <- sweep(twenty_three_AA_demand, 2, colSums(twenty_three_AA_demand), "/")
```
...
for (i in 1:length(cell_types_for_TE_analysis)) {
  ...
  AA_demand_from_mRNA <- twenty_three_AA_demand[, cell_types_for_TE_analysis[i]]
...
saveRDS(twenty_three_TE_results_tibble, paste0(processed_data_directory, "FH_23_translation_efficiency_results.rds"))
```
...
```{r}
# load translation efficiency results 
twenty_three_TE_results_tibble <- readRDS(paste0(processed_data_directory, "FH_23_translation_efficiency_results.rds"))
```
...
ggsave("/Volumes/Samsung_USB/Fulbright/reviewer_stuff/FH_23_TEs.pdf", height = 6, width = 6)
```
...
ggsave("/Volumes/Samsung_USB/Fulbright/reviewer_stuff/FH_23_TE_p_values.pdf", height = 6, width = 6)
```
...
# divide normalized AA supply by normalized AA demand for each cell type available for TE analysis
twenty_three_AA_supply_versus_demand <- t(twenty_three_AA_supply_per_cell_type[twenty_three_AAs, cell_types_for_TE_analysis] / twenty_three_AA_demand_per_cell_type[twenty_three_AAs, cell_types_for_TE_analysis])
```
...
ggsave("/Volumes/Samsung_USB/Fulbright/reviewer_stuff/FH_23_AA_SD_ratio_violins.pdf", height = 6, width = 6)
...
ggsave("/Volumes/Samsung_USB/Fulbright/reviewer_stuff/FH_23_AA_SD_ratio_barplot.pdf", height = 6, width = 6)
```
